...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Testimony'
        db.create_table(u'core_testimony', (
        ...
        db.send_create_signal(u'core', ['Testimony'])

        # Adding model 'TestimonyGalleryImage'
        db.create_table(u'core_testimonygalleryimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('news', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Testimony'])),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('cropping', self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255, blank=True)),
        ))
        db.send_create_signal(u'core', ['TestimonyGalleryImage'])


    def backwards(self, orm):
        # Deleting model 'Testimony'
        db.delete_table(u'core_testimony')

        # Deleting model 'TestimonyGalleryImage'
        db.delete_table(u'core_testimonygalleryimage')
    ...
    models = {
        ...
        u'core.testimonygalleryimage': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'news': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Testimony']"})
        }
    }
