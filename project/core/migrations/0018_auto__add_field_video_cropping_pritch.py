...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.cropping_pritch'
        db.add_column(u'core_video', 'cropping_pritch',
                      self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.cropping_pritch'
        db.delete_column(u'core_video', 'cropping_pritch')
