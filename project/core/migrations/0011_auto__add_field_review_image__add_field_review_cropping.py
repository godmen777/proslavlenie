...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.image'
        db.add_column(u'core_review', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Review.cropping'
        db.add_column(u'core_review', 'cropping',
                      self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.image'
        db.delete_column(u'core_review', 'image')

        # Deleting field 'Review.cropping'
        db.delete_column(u'core_review', 'cropping')
