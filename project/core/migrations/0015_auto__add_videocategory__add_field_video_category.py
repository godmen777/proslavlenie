...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_videocategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'core', ['VideoCategory'])

        # Adding field 'Video.category'
        db.add_column(u'core_video', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.VideoCategory'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'VideoCategory'
        db.delete_table(u'core_videocategory')

        # Deleting field 'Video.category'
        db.delete_column(u'core_video', 'category_id')
