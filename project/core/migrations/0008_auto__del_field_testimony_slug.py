...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Testimony.slug'
        db.delete_column(u'core_testimony', 'slug')


    def backwards(self, orm):
        # Adding field 'Testimony.slug'
        db.add_column(u'core_testimony', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=200, unique=True),
                      keep_default=False)
