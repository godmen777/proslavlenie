...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.input_video'
        db.add_column(u'core_review', 'input_video',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=240),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.input_video'
        db.delete_column(u'core_review', 'input_video')
