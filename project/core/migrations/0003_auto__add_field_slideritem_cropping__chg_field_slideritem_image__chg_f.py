...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SliderItem.cropping'
        db.add_column(u'core_slideritem', 'cropping',
                      self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'SliderItem.image'
        db.alter_column(u'core_slideritem', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'News.date'
        db.alter_column(u'core_news', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Deleting field 'SliderItem.cropping'
        db.delete_column(u'core_slideritem', 'cropping')


        # Changing field 'SliderItem.image'
        db.alter_column(u'core_slideritem', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'News.date'
        db.alter_column(u'core_news', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
