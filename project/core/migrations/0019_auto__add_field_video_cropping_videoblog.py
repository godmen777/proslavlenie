...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.cropping_videoblog'
        db.add_column(u'core_video', 'cropping_videoblog',
                      self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.cropping_videoblog'
        db.delete_column(u'core_video', 'cropping_videoblog')
    ...
    models = {
        ...
        u'core.video': {
            ...
            'cropping': (u'django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '255', 'blank': 'True'}),
            'cropping_pritch': (u'django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '255', 'blank': 'True'}),
            'cropping_videoblog': (u'django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '255', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
