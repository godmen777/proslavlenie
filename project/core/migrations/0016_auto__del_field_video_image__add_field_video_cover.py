...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_video', 'image')

        # Adding field 'Video.cover'
        db.add_column(u'core_video', 'cover',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_video', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'Video.cover'
        db.delete_column(u'core_video', 'cover')
